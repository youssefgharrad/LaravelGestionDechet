<style>
    ...
    .btn-8 {
        ...
        background-image: linear-gradient(315deg, #f0ecfc 0%, #850f15 74%);
        line-height: 42px;
        padding: 0;
        border: none;
    }
        ...
        <div class="container py-5">
            @if ($events->isNotEmpty())
                <div class="text-center mx-auto pb-5 wow fadeInUp" data-wow-delay="0.2s" style="max-width: 800px;">
                    <h1 class="display-4 mb-4">Vos participations</h1>
                    <p class="mb-0">
                        Vous trouverez ici la liste des événements auxquels vous avez participé. Vous avez également la
                        possibilité de gérer vos inscriptions, y compris la suppression de vos participations si nécessaire.
                    </p>
                </div>
                            ...
                            <div class="blog-item d-flex">
                                ...
                                <div class="position-relative" style="width: 150px;">
                                    ...
                                    <img src="{{ $imagePath }}" class="img-fluid rounded-top w-100"
                                        alt="{{ $event->nomEvent }}" style="height: 250px; object-fit: cover;">
                                ...
                                <div class="blog-content p-4" style="flex: 1;">
                                    <h5 class="d-inline-block mb-3">{{ $event->nomEvent }}</h5>
                                    ...
                                    <div class="button-container d-flex justify-content-between">
                                        ...
                                        <form action="{{ route('evenementFront.supprimer', ['id' => $event->id]) }}"
            ...
            @else
                <p class="text-center">Vous n'avez aucun événement !</p>
            @endif
        </div>

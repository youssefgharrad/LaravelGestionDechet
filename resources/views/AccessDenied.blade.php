...
<head>
    ...
    <style>
        ...
        .btn-home:hover {
            ...
            /* Couleur un peu plus claire au survol */
            box-shadow: 0 0 5px #5BE0B3, 0 0 20px #5BE0B3;
        }
    </style>
</head>
...
<body>
    ...
    <div class="message2">Vous avez tenté d'accéder à une page pour laquelle vous n'aviez pas d'autorisation préalable.
        <a href="{{ route('dashboard') }}" class="btn-home">Retourner à la page d'accueil</a>
